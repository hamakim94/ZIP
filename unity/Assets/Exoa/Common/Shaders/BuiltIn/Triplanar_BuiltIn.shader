...
Shader "Exoa/Triplanar_BuiltIn" {
	Properties {
		...
		[HideInInspector] _VertexColorStrength("Vertex Color Strength", Range(0.0,1.0)) = 1.0
		...
		[HideInInspector] _UsingSpecGlossMap("Using Spec Gloss Map", float) = 0.0

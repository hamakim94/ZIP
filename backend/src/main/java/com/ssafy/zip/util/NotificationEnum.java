...
public enum NotificationEnum {
    ...
    QnaMissionAccomplished("가족과 함께하는 ‘오늘의 백문백답’ 미션을 성공했습니다!","myapp://zip.com/qna/%s"),
    TodayLetterMissionAccomplished("가족과 함께하는 ‘오늘의 편지’ 미션을 성공했습니다!","myapp://zip.com/board"),
    ScheduleRegistedForMe("%s님이 함께하는 일정을 등록했습니다. 확인해보세요!","myapp://zip.com/calendar"),
    TodayLetterSentTome("%s님에게 오늘의 편지가 도착했습니다. 확인해보세요!","myapp://zip.com/board"),

...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_API_URI = {
            "/api/post/letter/reset","/api/users/signup", "/api/users/login", "/api/users/duplication-check", "/api/users/password", "/api/users/reissue", "/api/users/confirm-email", "/api/users/characters"
    };
